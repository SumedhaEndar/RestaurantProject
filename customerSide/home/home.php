...
// Fetch menu data from DB before rendering HTML
      ...
      <div class="mainDish">
        ...
        <?php foreach ($mainDishes as $item): ?>
          <p>
            ...
            <span class="item-price">RM<?php echo htmlspecialchars($item['item_price']); ?></span><br>
...
<section id="about">
  <div class="about container">
    <div class="col-right">
      ...
      <p>Johnny's Dining & Bar is a well-established Western food establishment in the city's heart. Johnny's Dining & Bar has become a popular choice for customers looking to celebrate special occasions or simply enjoy a relaxing meal, with a focus on providing delicious meals and a friendly dining experience.</p>
